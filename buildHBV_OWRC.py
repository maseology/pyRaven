...
from pyRaven import batchfile, hru, rvc_hbv, rvh_hbv, rvi_hbv, rvp_hbv, rvt_OWRCapi, rvt_Obs, rvt_Res, parameters, reservoir



def HBV_OWRC(ins, xrlu, xrsg):
    ...
    if 'submodel' in ins.params['options']:
        ...
        if type(outsb)==int:
            ...
            rvi_hbv.write(root, nam, builder, ver, ins.params['dtb'], ins.params['dte'], res, ts, preonly)
